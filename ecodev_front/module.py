...
class Module(Frozen):
    ...
    access_checks: list[Callable] = []
        A list of functions which check if the user has access to module. Each method should have
        user as first argument, the project as second argument, and the session as third argument.
